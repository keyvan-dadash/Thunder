...
TEST(QueueBasicOperations, CreateQueue) {
  EXPECT_NO_THROW({ thunder::datastructures::Queue<int> queue; });
  EXPECT_NO_THROW({ thunder::datastructures::Queue<char> queue; });
  EXPECT_NO_THROW({ thunder::datastructures::Queue<float> queue; });
  EXPECT_NO_THROW({ thunder::datastructures::Queue<std::string> queue; });
}
...
TEST(QueueBasicOperations, PushElementToQueue) {
  {
    thunder::datastructures::Queue<int> queue;
    EXPECT_EQ(queue.push(5), thunder::datastructures::QueueOperationStatus::
                                 ELEMENT_PUSHED_SUCCESSFULLY);
  }
  {
    thunder::datastructures::Queue<char> queue;
    EXPECT_EQ(queue.push('c'), thunder::datastructures::QueueOperationStatus::
                                   ELEMENT_PUSHED_SUCCESSFULLY);
  }
  {
    thunder::datastructures::Queue<float> queue;
    EXPECT_EQ(queue.push(5.1), thunder::datastructures::QueueOperationStatus::
                                   ELEMENT_PUSHED_SUCCESSFULLY);
  }
  {
    thunder::datastructures::Queue<std::string> queue;
    EXPECT_EQ(queue.push("foo"), thunder::datastructures::QueueOperationStatus::
                                     ELEMENT_PUSHED_SUCCESSFULLY);
    EXPECT_EQ(queue.push(std::string("bar")),
              thunder::datastructures::QueueOperationStatus::
                  ELEMENT_PUSHED_SUCCESSFULLY);
  }
}
...
TEST(QueueBasicOperations, PopElementFromQueue) {
  {
    ...
    queue.push(5);
    int c;
    EXPECT_EQ(queue.pop(c), thunder::datastructures::QueueOperationStatus::
  ...
  }
  {
    ...
    queue.push(std::string("bar"));
    std::string front;
    EXPECT_EQ(queue.pop(front), thunder::datastructures::QueueOperationStatus::
                                    ELEMENT_POPED_SUCCESSFULLY);
