...
TEST(BucketBasicOperations, CreateBucket) {
    ...
    EXPECT_NO_THROW((
        []{thunder::datastructures::bucket<int, int, std::allocator<std::pair<int, int>>, 4> bucket;}()
    ));
    EXPECT_NO_THROW((
        []{thunder::datastructures::bucket<char, char, std::allocator<std::pair<char, char>>, 4> bucket;}()
    ));
    EXPECT_NO_THROW((
        []{thunder::datastructures::bucket<float, float, std::allocator<std::pair<float, float>>, 4> bucket;}()
    ));
    EXPECT_NO_THROW((
        []{thunder::datastructures::bucket<std::string, std::string, std::allocator<std::pair<std::string, std::string>>, 4> bucket;}()
    ));
}
...
TEST(BucketBasicOperations, SetKeyValueAndReteriveKey) {
    {
        ...
        traits_.construct(alloca, 
                            std::addressof(bucket.returnChangeableKeyValue(2)),
        ...
        traits_.construct(alloca, 
                            std::addressof(bucket.returnChangeableKeyValue(3)),
                            std::piecewise_construct,
                            std::forward_as_tuple(std::forward<int>(10)),
                            std::forward_as_tuple(std::forward<int>(10)));
