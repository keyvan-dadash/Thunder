...
class bucket {
 public:
  ...
  using traits_ = typename std::allocator_traits<
      Allocator>::template rebind_traits<key_value_item>;
 ...
 public:
  ...
  bool setKeyValueOnIndex(Key& key, Value& value, size_type ind) {
    ...
    *reinterpret_cast<key_value_item*>(&this->slots[ind]) =
  ...
  bool isSlotEmpty(size_type ind) { return !this->slotsStatus[ind]; }
